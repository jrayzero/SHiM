...
struct Iter : public Expr<Iter<Ident>> {
  ...
  dvar<loop_type> realize(const LhsIdxs &lhs_idxs, const builder::dyn_arr<loop_type,N> &iters) {
...
struct TemplateCast : public Expr<TemplateCast<To,CompoundExpr>> {
  ...
  template <typename LhsIdxs, unsigned long N>
  dvar<To> realize(const LhsIdxs &lhs_idxs, const builder::dyn_arr<loop_type,N> &iters);
...
struct Binary : public Expr<Binary<Functor, CompoundExpr0, CompoundExpr1>> {
  ...
  template <typename LhsIdxs, unsigned long N>
  dvar<Core_T> realize(const LhsIdxs &lhs_idxs, const builder::dyn_arr<loop_type,N> &iters);
...
dvar<typename GetCoreT<T>::Core_T> dispatch_realize(T to_realize, const LhsIdxs &lhs_idxs, const builder::dyn_arr<loop_type,N> &iters) {
...
template <typename Functor, typename CompoundExpr0, typename CompoundExpr1>
template <typename LhsIdxs, unsigned long N>
dvar<typename GetCoreT<CompoundExpr0>::Core_T> Binary<Functor,CompoundExpr0,CompoundExpr1>::realize(const LhsIdxs &lhs_idxs, const builder::dyn_arr<loop_type,N> &iters) {
...
template <typename To, typename CompoundExpr>
template <typename LhsIdxs, unsigned long N>
dvar<To> TemplateCast<To,CompoundExpr>::realize(const LhsIdxs &lhs_idxs, const builder::dyn_arr<loop_type,N> &iters) {
