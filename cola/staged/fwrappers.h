...
builder::dyn_var<void(bool,char*)> hassert = builder::as_global("COLA_ASSERT");
...
builder::dyn_var<uint64_t(uint64_t)> cast_uint64_t = builder::as_global("COLA_CAST_UINT64_T");
builder::dyn_var<char(char)> cast_char = builder::as_global("COLA_CAST_CHAR");
builder::dyn_var<int8_t(int8_t)> cast_int8_t = builder::as_global("COLA_CAST_INT8_T");
builder::dyn_var<int16_t(int16_t)> cast_int16_t = builder::as_global("COLA_CAST_INT16_T");
builder::dyn_var<int32_t(int32_t)> cast_int32_t = builder::as_global("COLA_CAST_INT32_T");
